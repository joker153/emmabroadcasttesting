...
async def start(bot, update): 
    update_channel = "@minnal_murali_2021_hdrip"
    if update_channel:
        try:
                    ...
                    [
                        [
                            InlineKeyboardButton
                                (
                                    'Channel✅️', url="https://t.me/minnal_murali_2021_hdrip"
                                )
                        ]
                    ]
                )
